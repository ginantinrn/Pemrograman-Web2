...
$query = mysqli_query($conn, "SELECT * FROM motor WHERE id = '$id'");
...
if (isset($_POST["submit"])) {
  ...
  $query =  "UPDATE motor SET nama_motor='$nama_motor', cc = '$cc', tipe_motor_id='$tipe_motor_id', harga='$harga', merk_id='$merk_id', stok='$stok' WHERE id= '$id'";
          ...
          <section class="col-10 col-sm-2 col-md-4">
            <form class="form-container" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_motor" name="nama_motor" aria-describeby="emailHelp" placeholder="Masukkan Motor" value="<?= $motor['nama_motor']; ?>">
              </div>
              <div class="form-group">
                <label for="number">CC</label>
                <input type="number" class="form-control" id="cc" name="cc" placeholder="Masukan CC Motor" value="<?= $motor['cc']; ?>">
              </div>
              <div class="form-group">
                <label for="number">Stok</label>
                <input type="number" class="form-control" id="stok" name="stok" placeholder="Masukan Stok Motor" value="<?= $motor['stok']; ?>">
              </div>
              <div class="form-group">
                <label for="number">Harga</label>
                <input type="number" class="form-control" id="harga" name="harga" placeholder="Masukan Harga Motor" value="<?= $motor['harga']; ?>">
              </div>
              <br>
