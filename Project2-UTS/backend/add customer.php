...
if (isset($_POST["submit"])) {
  ...
  $query = "INSERT INTO pesanan (nama_pelanggan, alamat_pelanggan, motor_id, quantity) VALUES ('$nama_pelanggan', '$alamat_pelanggan', '$motor_id', '$quantity')";
          ...
          <section class="col-10 col-sm-2 col-md-4">
            <form class="form-container" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="nama_pelanggan" placeholder="Masukkan Nama Pelanggan">
              </div>

              <!-- alamat_pelanggan -->
              <div class="form-group">
                <label for="alamat">Alamat Pelanggan</label>
                <input type="text" class="form-control" id="alamat" name="alamat_pelanggan" placeholder="Masukkan Alamat Pelanggan">
              </div>
